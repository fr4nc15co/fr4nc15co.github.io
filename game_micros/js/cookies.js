 ...
 *
 * Copia local del cookies.js de fr4nc15co.github.io para que el juego funcione
 * publicado en cualquier web estática (y offline). Divergencias: PRIVACY_URL
 * absoluta y no se muestra el banner si GA está desactivado (window.gtag no
 * definido — localhost sin `?ga`). Comparte la clave 'cookie-consent'.
 */
(function () {
  'use strict';

  var KEY = 'cookie-consent';            // 'granted' | 'denied'
  var PRIVACY_URL = 'https://fr4nc15co.github.io/privacidad.html';
  ...
  function init() {
    if (typeof window.gtag !== 'function') return; // GA desactivado: nada que consentir
